...
1. **Clone or download this repository**
   ...
   ```bash
   git clone https://github.com/d0rf47/spotifyAPIExporterTool
   cd SpotifyAPItool
   ```
...
│
├── views/               # EJS templates
│   ├── layout.ejs       # Unified layout with header/footer
...
Edit EJS templates in `views/content/`:
...
Edit the unified layout in `views/layout.ejs` to change header/footer
